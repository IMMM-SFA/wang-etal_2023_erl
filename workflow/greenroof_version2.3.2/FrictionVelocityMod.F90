...
#include "shr_assert.h"
  ...
  type, public :: frictionvel_type
     ...
     real(r8), pointer, public :: z_d_town_u_lun   (:)   
     real(r8), pointer, public :: z_0_town_u_lun   (:)  
     real(r8), pointer, public :: obu_u_lun        (:)  
     real(r8), pointer, public :: zeta_u_lun       (:)  
     real(r8), pointer, public :: ustar_u_lun      (:)  
     real(r8), pointer, public :: tstar_u_lun      (:)  
     real(r8), pointer, public :: va_u_lun         (:)  
...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%z_d_town_u_lun   (begl:endl)) ; this%z_d_town_u_lun   (:)   = nan
    allocate(this%z_0_town_u_lun   (begl:endl)) ; this%z_0_town_u_lun   (:)   = nan
    allocate(this%obu_u_lun        (begl:endl)) ; this%obu_u_lun        (:)   = nan
    allocate(this%zeta_u_lun       (begl:endl)) ; this%zeta_u_lun       (:)   = nan
    allocate(this%ustar_u_lun      (begl:endl)) ; this%ustar_u_lun      (:)   = nan
    allocate(this%tstar_u_lun      (begl:endl)) ; this%tstar_u_lun      (:)   = nan
    allocate(this%va_u_lun         (begl:endl)) ; this%va_u_lun         (:)   = nan
  ...
  subroutine InitHistory(this, bounds)
    ...
    this%z_d_town_u_lun(begl:endl) = spval
    call hist_addfld1d (fname='z_d_town_u', units='',  &
         avgflag='A', long_name='z_d_town_u', &
         ptr_lunit=this%z_d_town_u_lun, set_nourb=spval, l2g_scale_type='unity', default='inactive')

    this%z_0_town_u_lun(begl:endl) = spval
    call hist_addfld1d (fname='z_0_town_u', units='',  &
         avgflag='A', long_name='z_0_town_u', &
         ptr_lunit=this%z_0_town_u_lun, set_nourb=spval, l2g_scale_type='unity', default='inactive')

    this%obu_u_lun(begl:endl) = spval
    call hist_addfld1d (fname='obu_u', units='',  &
         avgflag='A', long_name='obu_u', &
         ptr_lunit=this%obu_u_lun, set_nourb=spval, l2g_scale_type='unity', default='inactive')

    this%zeta_u_lun(begl:endl) = spval
    call hist_addfld1d (fname='zeta_u', units='',  &
         avgflag='A', long_name='zeta_u', &
         ptr_lunit=this%zeta_u_lun, set_nourb=spval, l2g_scale_type='unity', default='inactive')

    this%ustar_u_lun(begl:endl) = spval
    call hist_addfld1d (fname='ustar_u', units='',  &
         avgflag='A', long_name='ustar_u', &
         ptr_lunit=this%ustar_u_lun, set_nourb=spval, l2g_scale_type='unity', default='inactive')

    this%tstar_u_lun(begl:endl) = spval
    call hist_addfld1d (fname='tstar_u', units='',  &
         avgflag='A', long_name='tstar_u', &
         ptr_lunit=this%tstar_u_lun, set_nourb=spval, l2g_scale_type='unity', default='inactive')

    this%va_u_lun(begl:endl) = spval
    call hist_addfld1d (fname='va_u', units='',  &
         avgflag='A', long_name='va_u', &
         ptr_lunit=this%va_u_lun, set_nourb=spval, l2g_scale_type='unity', default='inactive')
