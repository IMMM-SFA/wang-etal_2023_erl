...
!scs: vangenuchten
     ...
     real(r8), pointer :: thk_road_perv_col    (:,:) ! col thermal conductivity of road_perv [W/m-K] 
     real(r8), pointer :: cv_road_perv_col     (:,:) ! col heat capacity of road_perv (J/m**3/Kelvin) 
...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%thk_road_perv_col    (begc:endc,1:nlevgrnd))          ; this%thk_road_perv_col    (:,:) = nan
    allocate(this%cv_road_perv_col     (begc:endc,1:nlevgrnd))          ; this%cv_road_perv_col     (:,:) = nan
  ...
  subroutine InitHistory(this, bounds)
    ...
    this%thk_road_perv_col(begc:endc,:) = spval 
    call hist_addfld2d (fname='TK_perroad', units='W/m-K', type2d='levgrnd', &
          avgflag='A', long_name='urban perroad thermal conductivity', &
          ptr_col=this%thk_road_perv_col, default='inactive')    

    this%cv_road_perv_col(begc:endc,:) = spval 
    call hist_addfld2d (fname='CV_perroad', units='J/(m3 K)', type2d='levgrnd', &
          avgflag='A', long_name='urban perroad heat capacity', &
          ptr_col=this%cv_road_perv_col, default='inactive')    
