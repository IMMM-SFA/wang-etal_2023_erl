...
#include "shr_assert.h"
  ...
  type, public :: waterstate_type
     ...
     real(r8), pointer :: fwet_road_imperv_lun   (:)   ! lun fraction of imperv surface that is wet (-)
...
# endif
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%fwet_road_imperv_lun   (begl:endl))                     ; this%fwet_road_imperv_lun   (:)   = nan
...
!         ptr_col=this%h2osoi_liq_col, l2g_scale_type='veg')
    ...
    this%fwet_road_imperv_lun(begl:endl) = spval
    call hist_addfld1d (fname='FWET_improad', units='unitless',  &
         avgflag='A', long_name='fraction of imperv surface that is wet', &
         ptr_lunit=this%fwet_road_imperv_lun, c2l_scale_type='urbanf', default='inactive')
