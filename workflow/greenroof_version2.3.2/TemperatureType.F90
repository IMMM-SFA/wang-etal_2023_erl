...
#include "shr_assert.h"
  ...
  type, public :: temperature_type
     ...
     real(r8), pointer :: t_roof_innerl_lun        (:)   ! lun temp of inner layer of roof (K)
...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%t_roof_innerl_lun        (begl:endl))                      ; this%t_roof_innerl_lun        (:)   = nan
  ...
  subroutine InitHistory(this, bounds, is_simple_buildtemp, is_prog_buildtemp )
    ...
    this%t_roof_innerl_lun(begl:endl) = spval
    call hist_addfld1d(fname='t_roof_innerl', units='K',  &
        avgflag='A', long_name='inner layer of roof temperature', &
        ptr_lunit=this%t_roof_innerl_lun, set_nourb=spval, l2g_scale_type='unity', &
        default='inactive')
