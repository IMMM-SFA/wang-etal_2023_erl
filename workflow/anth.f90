...
use netcdf
implicit none
integer,parameter::clon=464,clat=224,ngrid=5412,bhr=24,bsea=2,dims=3,npoint=4,nvar=18,nvar2=5,nvar3=10
...
real station1(nvar3,npoint,bhr),station2(nvar3,npoint,bhr,nmon),station3(nvar3,npoint,bhr,bsea),deltaTaQaf(4,clon,clat,bhr)
...
call check( nf90_put_att(ncid, nf90_global, 'history', 'Created by Linying Wang, BU, 2021-06') )
  ...
  do kmon=1,6
    ...
    do iday=1,bday(imon)
      ...
      do i=1,npoint
        ...
        station1(8,i,:) = station1(8,i,:) + WIND(plon(i),plat(i),:)
